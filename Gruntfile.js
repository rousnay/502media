...
copy: {
  ...
  build_js: { // need to dynamic_mappings http://gruntjs.com/configuring-tasks#globbing-patterns
    ...
    {expand: true, flatten: true, src: ['<%= project.bower %>/isotope-packery/packery-mode.pkgd.min.js'], dest: 'js/', filter: 'isFile'},
...
browserSync: {
  main: {
    ...
    options: {
      ...
      proxy: 'http://10.91.149.145/502mediagroup/502media/'
    }
  }
},
